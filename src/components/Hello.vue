            ...
            <div class="col-md-12 big-box">
                <div class="flex-container">
                    <div class="flex-item">
                        ...
                        <h3 class="heading">Marketer x Web Developer</h3>
                        <h6 class="maintext">A self-motivated web developer who thinks like a marketer. Values hard-work, design, and organization.</h6>

                        <p class="sub-text">
                            <i class="fa fa-linkedin" aria-hidden="true"></i> <a href="https://www.linkedin.com/in/rachmason">rachmason</a>
                            <i class="fa fa-github" aria-hidden="true"></i><a href="rachelmason.github.io/">rachelmason</a>
                            <i class="fa fa-instagram" aria-hidden="true"></i> <a href="https://www.instagram.com/raemase/">raemase</a>
                            <i class="fa fa-envelope" aria-hidden="true"></i> ramason@icloud.com
                        </p>
            <a class="btn-floating btn-large waves-effect waves-light halfway-fab" data-target="modal1" @click="openModal"><i class="material-icons">email</i></a>
                    </div>
